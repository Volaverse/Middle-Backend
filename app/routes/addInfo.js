...
module.exports = function(app) {
    ...
    app.post('/addInfo',    async (req,res) =>{
        ...
        try {
          ...
          if(exsistingUser) return res.status(200).json({message: "Username already taken"})
  
          const newuser = await userData.create({fullName, userName, phoneNumber, age,email,liskAddress})
